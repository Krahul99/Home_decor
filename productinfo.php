...
<body>
        ...
        <div class="main2" >
            ...
            <div class="login-box"><br>
                ...
                <table>
                    ...
                    <tr>
                        <td colspan="3"><center><button id="editprofile" class="btn1" onclick="editproduct(<?php echo $temp;?>)">Edit Product</button></center></td>
                    </tr>
                </table>
            </div>
            <div class="pic-box">
    ...
    <script type="text/javascript">
        function editproduct($temp) {
            window.location.replace("editadminproduct.php?tid="+$temp);
        }
    </script>
</body>
</html>