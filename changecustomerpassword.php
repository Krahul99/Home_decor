        ...
        while($row = mysqli_fetch_assoc($result)){
            if($row["Password"]==$_POST['current_password']){
                if($Password == $VerifyPassword){
                    $query='update customer set Password="'.$Password.'" where Emailid="'.$_SESSION["Emailid"].'"';
                }
            }
        }
...
<body>
    ...
    <div class="login-box">
        ...
        <hr style="border:1px solid"><br><br>
            <center>
                <table>
                    <form action="changecustomerpassword.php"  method="POST" enctype="multipart/form-data" >
