...
if($_SERVER['REQUEST_METHOD'] == "POST"){
    ...
    $Pname=rand(1000,10000).".".$_FILES["customerProfile"]["name"];
    $tname=$_FILES["customerProfile"]["tmp_name"];
    move_uploaded_file($tname, "customerprofile/".$Pname);
    ...
    if($num > 0){
        ...
        if($Password != $VerifyPassword){
           ...
           $sql = "INSERT INTO `customer` (`customerProfile`,`FirstName`, `LastName`, `Gender`, `DOB`,`Cellno`, `Emailid`, `Password`, `Address`,`State`) VALUES('$Pname','$FirstName','$LastName', '$Gender', '$DOB', '$Cellno', '$Emailid', '$Password','$Address','$State')";
            $result = mysqli_query($conn, $sql);
            if($result)
            {
                $succ = true;
...
<body>
        ...
        <div clas="main">
         ...
         <div class="heading">
            ...
            <ul>   
                ...
                <li class="active"><a href="customer_login.php" class="ex1">Customer</a></li>
    ...
    <div class="login-box">
        <center><h3>Customer Signup</h3></center><br>
            ...
            <center>
                <table>
                    <form action="customer_signup.php"  method="POST" enctype="multipart/form-data" >
                        ...
                        <tr>
                            <td colspan="2"><center><label name="customerProfile" for="customerProfile" class="pic"> Profile Picture</label><input name="customerProfile" id="customerProfile" type="file" accept="image/*" onchange="showPreview(event);" hidden required></td>
                        </tr>
                        <tr>
                            <td><br></td>
                        </tr>
